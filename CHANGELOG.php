Version actuelle : 12.0.1 (26/08/25)
===================
Changements :
...
9.2.2 04/07/20 Corrections de bugs
  Nouvelle fonctionnalité : visualisation de vidéos en streaming
10.0.0 31/08/2022 Nouvelles fonctionnalités :
  * Possibilité pour les utilisateurs non profs d'éditer des informations
  * Icônes générales du menu pour un accès direct aux fonctionnalités
  * Généralisation du transfert de documents vers/par les colleurs, lycée
  * Comptes administrateurs non nécessairement professeurs et inversement
  * Comptes professeur-colleur (prof dans une matière, colleur dans une autre)
  * Affichage en ligne des vidéos et fichiers sonores
  * Mode lecture, mode « vision en tant que » pour les professeurs
  * Meilleure visiblité des protections
  * Amélioration de la saisie des notes de colles. Décompte automatique du 
    temps déclaré, modifiable par le professeur après coup. 
  * Commentaires de colle visibles par les professeurs
  * Page unique de lecture des notes de colles pour les élèves
  * Amélioration de la relève des colles. Statistiques. Accès aux professeurs.
  * Envoi de courriel vers des destinataires cachés uniquement
  * « Blog de CdP » : interface permettant à l'admnistrateur global du site
    de faire passer des messages à l'ensemble des utilisateurs
  * Renvoi d'invitation
10.0.1 03/09/2022 Corrections de bugs
10.0.2 04/11/2022 Corrections de bugs et améliorations de la relève des notes
11.0.0 03/09/2023 Nouvelles fonctionnalités :
  * Mode sombre paramétrable prenant la valeur du navigateur par défaut
  * Recherche des utilisateurs dans les pages de gestion et améliorations de 
    l'interface
  * Ajout de pièces jointes dans les courriels
  * Amélioration de l'interface d'envoi des courriels : recherche des 
    destinataires, système de copié-collé de liens vers des documents
  * Agenda : modification de l'interface côté professeurs et côté élèves
  * Agenda : vue en semaine ou en mois
  * Agenda : possibilité de programmer un événement récurrent
  * Agenda : possibilité de spécifier des droits d'accès en lecture/édition sur
  chaque événement, disponibilité ultérieure, affichage ou non sur la page 
  d'accueil. 
  * Agenda : préférences fines d'affichage sur la page d'accueil
  * Correction de bug : documents sans extension, mode lecture
11.0.1 29/06/2024 Corrections de bugs
11.0.2 04/01/2025 Corrections de bugs
12.0.0 23/08/2025 Nouvelles fonctionnalités :
  * Réécriture de l'interface globale, qui devient "Cahier de Prépa Multi (V1)"
  * Suppression multiple possible d'informations
  * Suppression multiple possible de répertoires/documents
  * Transferts de documents : envoi possible du même fichier à plusieurs élèves
  * Transferts de documents : modification de l'interface, tableau récapitulatif
  * Transferts de documents : possibilité d'envoyer directement un mail aux 
  élèves qui n'ont pas encore participé
  * Transferts de documents : possibilité de ne pas mettre de deadline
  * Transferts de documents : première page générale avec liste des transferts
  * Documents : possibilité de téléchargement multiple avec arborescence
  * Documents et transferts de documents : mise en évidence de la possibilité de
  lire des vidéos directement sur le site, possibilité de lire des mp3, de coder
  des fichiers python.
  * Notes de colles : semaines de type « préparation à l'oral » qui permettent
  de ne plus avoir la limitation du nombre de passage par élève par semaine.
  * Notes de colles : première page générale avec liste des heures (colleurs)
  * Notes de colles : possibilité d'envoyer directement un mail aux élèves
  * Correction de bugs : MathJax dans les indications de transferts, édition 
  des élèves dans l'agenda, nom de fichiers avec une apostrophe, lignes longues
  coupées dans les entêtes des mails.
12.0.1 26/08/2025 
  * Corrections de bugs (suppression de documents, noms de fichiers, 
  autorisation d'édition de l'agenda)
  * Raccourcis du cahier de texte : possibilité de choisir le sens d'ajustement
  du jour (précédent ou suivant)
  * Planning : décompte total des semaines
===================

Todo :

[ 13.0 ] Août 2026
  * Compteur de téléchargements des documents
  * Journal : enregistrement en base de données plutôt que dans un fichier
  ...
  * Module correction devoir
  * Module parcoursup
  * Interface globale : accès à tous les cahiers simultanément, avec les différentes matières
  * Pseudo-tableau modifiable par tous
  * Image en bandeau sous le titre
  * Suppression d'un événement par un prof hors de sa matières
  * Template de renommage des transferts
...
Autres remarques / propositions :
  ...
  * Suppression programmée de document 
